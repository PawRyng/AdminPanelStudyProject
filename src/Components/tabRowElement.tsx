...
const TabRowComponent: React.FC<Params> = ({name,id, price, quantity, email, modalLabel, editPath}) => {
    ...
    <>
        ...
        <Modal isOpen={isModalOpen} onClose={closeModal}>
            ...
            <div className="modal-actions">
                <Form method="post" action="/dashboard/products/delete">
                    <input className='hidden' type="text" value={id}/>
